            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a class="btn btn-primary py-2 px-4 ml-auto d-none d-lg-block" href="student-profile.php">Profile</a>
                    </div>
                </nav>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    ...
                    <p><b>AcademySite</b> is a top provider of education and training in many fields.  
                        ...
                        Whether you're looking to start a new career or advance in your current field, we invite you to explore our programs and discover how <b>AcademySite</b> can help you achieve your goals. 
                    </div>
            </div>
        </div>
    </div>
